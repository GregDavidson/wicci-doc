...
the 1970s. The original Postgres was Monotonic! Whenever a Table Row in Postgres was updated
or deleted, the original row was saved and migrated to a /Tertiary Storage
System/, a write-once Optical Jukebox with plenty of storage capacity (although
